...
def parse_yaml_config(config_path: str) -> Dict[str, Any]:
    ...
    benchmarks:
      ...
      - framework: huggingface
        ...
        # quantizations auto-detected based on model
    ```
    """
    try:
        import yaml
...
def generate_test_configs(
    ...
    for bench in benchmarks:
        ...
        model = bench.get("model", "small")
        
        # Get quantizations - can be list or single value
        quantizations = bench.get("quantizations", [])
        ...
        # Get devices
        devices = bench.get("devices", ["cuda"])
        if isinstance(devices, str):
            devices = [devices]
        
        # Get beam sizes
        beam_sizes = bench.get("beam_sizes", [1])
...
class BenchmarkHarness:
    ...
    def __init__(
        ...
        self.test_configs = generate_test_configs(
    ...
    def run_all(self, audio_path: str, ground_truth: Optional[str] = None):
        ...
        for i, config in enumerate(self.test_configs, 1):
            ...
            try:
                ...
                result = runner.run(audio_path, ground_truth)
